...
void loop() {
  ...
  //for(uint8_t i=0; i<16; i++){              // ring out io expander
  ...
  //midiNoteOn(60, 100);                      // ring out Midi DIN Out
  //delay(500);  
  //midiNoteOff(60);
  //delay(500);

  if (midiDIN.read()){                        // ring out Midi DIN In 
    //midiDIN.getType();
    //midiDIN.getData1();
    //midiDIN.getData2();

    midiUSB.sendNoteOn(60, global_midi_velocity, global_midi_channel);
    //midiNoteOn(60, 100);   
    delay(50);  
    midiUSB.sendNoteOn(60, 0, global_midi_channel);
    //midiNoteOff(60);
    delay(50);
